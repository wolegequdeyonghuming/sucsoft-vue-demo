...
<script>
  ...
  import {Vector as VectorSource, OSM, XYZ, TileArcGISRest, TileWMS, Cluster} from "ol/source";
  ...
  export default {
    ...
    methods: {
      ...
      drawContour(){
        ...
        // contourLayer.getSource().addFeatures(features);
        features.forEach((feature)=>{
      ...
      onButton10Click(){
        ...
        points.forEach((point)=>{
          ...
          //添加点位对应的weight 权重
          feature.set("weight", point_weight);   //weight 和HeatmapLayer中设置的'weight'对应
